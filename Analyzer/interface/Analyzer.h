...
private:
	...
	double muon_eta[100];
	double muon_phi[100];
	int muon_isGlobalMuon[100];
	int muon_isTrackerMuon[100];
	int muon_isStandAloneMuon[100];
	int muon_InnerTrack_isNonnull[100];
	int muon_OuterTrack_isNonnull[100];
	
	double muon_OuterTrack_InnerPoint_x[100];
	double muon_OuterTrack_InnerPoint_y[100];
	double muon_OuterTrack_InnerPoint_z[100];
	double muon_OuterTrack_InnerPoint_px[100];
	double muon_OuterTrack_InnerPoint_py[100];
	double muon_OuterTrack_InnerPoint_pz[100];
	double muon_OuterTrack_OuterPoint_x[100];
	double muon_OuterTrack_OuterPoint_y[100];
	double muon_OuterTrack_OuterPoint_z[100];
	double muon_OuterTrack_OuterPoint_px[100];
	double muon_OuterTrack_OuterPoint_py[100];
	double muon_OuterTrack_OuterPoint_pz[100];
	double muon_InnerTrack_InnerPoint_x[100];
	double muon_InnerTrack_InnerPoint_y[100];
	double muon_InnerTrack_InnerPoint_z[100];
	double muon_InnerTrack_InnerPoint_px[100];
	double muon_InnerTrack_InnerPoint_py[100];
	double muon_InnerTrack_InnerPoint_pz[100];
	double muon_InnerTrack_OuterPoint_x[100];
	double muon_InnerTrack_OuterPoint_y[100];
	double muon_InnerTrack_OuterPoint_z[100];
	double muon_InnerTrack_OuterPoint_px[100];
	double muon_InnerTrack_OuterPoint_py[100];
	double muon_InnerTrack_OuterPoint_pz[100];
	
	//cosmicmuon variables
	double cosmicmuon_pt[100];
	double cosmicmuon_px[100];
	double cosmicmuon_py[100];
	double cosmicmuon_pz[100];
	double cosmicmuon_energy[100];
	double cosmicmuon_charge[100];
	double cosmicmuon_eta[100];
	double cosmicmuon_phi[100];
	int cosmicmuon_isGlobalMuon[100];
	int cosmicmuon_isTrackerMuon[100];
	int cosmicmuon_isStandAloneMuon[100];
	int cosmicmuon_InnerTrack_isNonnull[100];
	int cosmicmuon_OuterTrack_isNonnull[100];
	
	double cosmicmuon_OuterTrack_InnerPoint_x[100];
	double cosmicmuon_OuterTrack_InnerPoint_y[100];
	double cosmicmuon_OuterTrack_InnerPoint_z[100];
	double cosmicmuon_OuterTrack_InnerPoint_px[100];
	double cosmicmuon_OuterTrack_InnerPoint_py[100];
	double cosmicmuon_OuterTrack_InnerPoint_pz[100];
	double cosmicmuon_OuterTrack_OuterPoint_x[100];
	double cosmicmuon_OuterTrack_OuterPoint_y[100];
	double cosmicmuon_OuterTrack_OuterPoint_z[100];
	double cosmicmuon_OuterTrack_OuterPoint_px[100];
	double cosmicmuon_OuterTrack_OuterPoint_py[100];
	double cosmicmuon_OuterTrack_OuterPoint_pz[100];
	double cosmicmuon_InnerTrack_InnerPoint_x[100];
	double cosmicmuon_InnerTrack_InnerPoint_y[100];
	double cosmicmuon_InnerTrack_InnerPoint_z[100];
	double cosmicmuon_InnerTrack_InnerPoint_px[100];
	double cosmicmuon_InnerTrack_InnerPoint_py[100];
	double cosmicmuon_InnerTrack_InnerPoint_pz[100];
	double cosmicmuon_InnerTrack_OuterPoint_x[100];
	double cosmicmuon_InnerTrack_OuterPoint_y[100];
	double cosmicmuon_InnerTrack_OuterPoint_z[100];
	double cosmicmuon_InnerTrack_OuterPoint_px[100];
	double cosmicmuon_InnerTrack_OuterPoint_py[100];
	double cosmicmuon_InnerTrack_OuterPoint_pz[100];
	...
	double HERecHit_subset_energy[10000];
	double HERecHit_subset_time[10000];
	double HERecHit_subset_depth[10000];
	double HERecHit_subset_phi[10000];
	double HERecHit_subset_eta[10000];
	double HERecHit_subset_x[10000];
	double HERecHit_subset_y[10000];
	double HERecHit_subset_z[10000];
